    ...
    <div className="space-y-8 max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        <Card className="flex items-center gap-4 border border-slate-100">
          <div className="p-4 rounded-xl bg-primary-50 border border-primary-100 text-primary-600">
        ...
        <Card className="flex items-center gap-4 border border-slate-100">
          <div className="p-4 rounded-xl bg-amber-50 border border-amber-100 text-amber-600">
        ...
        {activeTab === 'overview' && (
          <Card className="space-y-6">
            <h3 className="text-lg font-bold text-slate-800 flex items-center gap-2">
              <HiTrendingUp className="text-primary-600" />
              System Status
            </h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <Card className="h-fit">
              <h3 className="text-base font-bold text-slate-800 mb-4 flex items-center gap-1.5">
                <HiPlusCircle className="text-primary-600 h-5 w-5" />
                Add Category
              </h3>
