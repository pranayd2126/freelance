        ...
        <div className="lg:col-span-2 space-y-6">
          <Card className="space-y-6">
            <h3 className="text-lg font-bold text-slate-800 border-b border-slate-100 pb-3 flex items-center gap-2">
              <HiFolderOpen className="text-primary-600 h-5 w-5" /> Posted Projects History
            </h3>
            ...
            {projects.length === 0 ? (
              ...
              <div className="space-y-4">
                {projects.map((project) => (
                  <div
                    key={project._id}
                    className="p-4 border border-slate-100 rounded-xl hover:border-primary-100 bg-slate-50/50 hover:bg-slate-50 transition-all flex flex-col md:flex-row justify-between items-start md:items-center gap-4"
                  >
                    <div className="space-y-1.5 flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-4 text-slate-400 text-xs">
                        <span className="flex items-center gap-1 font-semibold text-slate-500">
                          <HiCurrencyDollar className="h-4 w-4 text-primary-500" /> Budget:{' '}
