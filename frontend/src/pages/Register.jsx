  ...
  return (
    <div className="space-y-6">
      <div className="text-center md:text-left">
        <h2 className="text-2xl font-black text-stone-850 tracking-tight">Create Account</h2>
        <p className="text-sm text-stone-550 mt-1 font-medium">Get started on the StudentBid marketplace</p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
        <button
          ...
          className={`flex flex-col items-center gap-2 p-3 rounded-xl border text-center transition-all cursor-pointer select-none ${
            role === 'student'
              ? 'bg-orange-50/70 border-orange-600 text-orange-700 font-bold'
              : 'bg-white border-stone-200 text-stone-500 hover:border-stone-350 hover:bg-stone-50'
          }`}
        >
        ...
        >
          ...
          <span className="text-xs font-semibold">Join as Client</span>
        </button>
      </div>
      ...
      <div className="text-center text-xs text-stone-500 font-medium">
        ...
        <Link to="/login" className="font-bold text-orange-600 hover:text-orange-850">
          Sign In here
        </Link>
      </div>
    </div>
