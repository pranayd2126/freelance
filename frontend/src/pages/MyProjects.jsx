      ...
      <div className="border-b border-slate-200 mb-8">
        <nav className="-mb-px flex space-x-8" aria-label="Tabs">
          {[
            ...
            { id: 'assigned', label: 'Assigned', icon: HiUserGroup, color: 'text-amber-500' },
            { id: 'completed', label: 'Completed', icon: HiCheckCircle, color: 'text-primary-500' }
          ].map((tab) => {
            ...
            return (
              ...
              >
                ...
                <span className={`
                  ...
                  ${isActive ? 'bg-primary-100 text-primary-800' : 'bg-slate-100 text-slate-550'}
                `}>
                  {count}
                </span>
              </button>
