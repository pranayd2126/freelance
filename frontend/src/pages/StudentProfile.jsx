        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          <Card className="space-y-6">
            <h3 className="text-lg font-bold text-slate-800 border-b border-slate-100 pb-3 flex items-center gap-2">
              <HiBriefcase className="text-primary-600 h-5 w-5" /> Experience
            </h3>
            {experience.length === 0 ? (
              ...
              <div className="space-y-6">
                {experience.map((exp, idx) => (
                  <div key={idx} className="relative pl-6 border-l-2 border-slate-100 last:border-0 pb-4 last:pb-0">
                    <div className="absolute -left-[7px] top-1.5 w-3 h-3 bg-primary-600 rounded-full"></div>
                    <div className="flex justify-between items-start">
                      <div>
                        <h4 className="text-sm font-bold text-slate-800">{exp.role}</h4>
                        <p className="text-xs text-primary-600 font-medium mt-0.5">{exp.company}</p>
                      </div>
          ...
          <Card className="space-y-6">
            <h3 className="text-lg font-bold text-slate-800 border-b border-slate-100 pb-3 flex items-center gap-2">
              <HiAcademicCap className="text-primary-600 h-5 w-5" /> Education
            </h3>
            {education.length === 0 ? (
              ...
              <div className="space-y-6">
                {education.map((edu, idx) => (
                  <div key={idx} className="relative pl-6 border-l-2 border-slate-100 last:border-0 pb-4 last:pb-0">
                    <div className="absolute -left-[7px] top-1.5 w-3 h-3 bg-primary-500 rounded-full"></div>
          ...
          <Card className="space-y-6">
            <h3 className="text-lg font-bold text-slate-800 border-b border-slate-100 pb-3 flex items-center gap-2">
              <HiCollection className="text-primary-600 h-5 w-5" /> Portfolio
            </h3>
            {portfolio.length === 0 ? (
          ...
          <Card className="space-y-6">
            <h3 className="text-lg font-bold text-slate-800 border-b border-slate-100 pb-3 flex items-center gap-2">
              <HiBadgeCheck className="text-primary-600 h-5 w-5" /> Client Reviews
            </h3>
            {reviews.length === 0 ? (
