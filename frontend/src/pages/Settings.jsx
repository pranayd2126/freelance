      ...
      {activeTab === 'profile' ? (
        <Card>
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <Button type="submit" isLoading={isLoading} className="shadow-lg shadow-primary-100">
              Save Changes
            </Button>
          </form>
        </Card>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6">
            ...
            <div className="space-y-2 text-center sm:text-left">
              ...
              <label className="inline-flex cursor-pointer">
                ...
                />
                <span className="bg-primary-600 hover:bg-primary-700 text-white text-xs font-semibold px-4 py-2 rounded-lg transition-colors shadow-sm">
